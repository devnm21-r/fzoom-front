...
import cover from "../images/cafe.jpg";
    ...
    <section className={classes.presentation}>
      <div className={classes.introduction}>
        ...
        <Typography variant="body2" className={classes.paragraph}>
          Now, be able to order you're food even before you reach
          the restaurant! 
          You're time ad effort is precious to us!
        </Typography>
      ...
      <div className={classes.cover}>
        <img src={cover} alt="restaurant" className={classes.coverImg} />
      </div>
    </section>
  );
};
